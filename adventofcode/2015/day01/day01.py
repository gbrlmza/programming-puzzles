...
def main():
    ...
    for i, move in enumerate(moves):
        ...
        if floor == -1 and basement_position is None:
            basement_position = i + 1 # Arrays starts at zero ;)

    print("The final floor is: {}".format(floor))
    print("The first enter into the basement is in position: {}".format(basement_position))
